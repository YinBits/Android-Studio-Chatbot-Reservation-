 ...
 */
export declare function viewRemoveEventRegistration(view: View, eventRegistration: EventRegistration | null, cancelError?: Error): EventoItem[];
/**
 * Applies the given Operation, updates our cache, and returns the appropriate events.
 */
export declare function viewApplyOperation(view: View, operation: Operation, writesCache: WriteTreeRef, completeServerCache: Node | null): EventoItem[];
export declare function viewGetInitialEvents(view: View, registration: EventRegistration): EventoItem[];
