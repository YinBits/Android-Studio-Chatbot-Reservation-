 ...
 * built around the Node.js [EventoItem Loop](https://nodejs.org/en/docs/guides/event-loop-timers-and-nexttick/#setimmediate-vs-settimeout).
...
declare module "timers" {
    ...
    global {
         ...
         * @since v0.9.1
         * @param callback The function to call at the end of this turn of the Node.js `EventoItem Loop`
         * @param args Optional arguments to pass when the `callback` is called.
