...
public class Bebidas extends Fragment {
    ...
    private List<MenuItem> bebidaList;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        bebidaList.add(new MenuItem("Pratos 2", "Descrição da pratos 2", 4.99, ""));
        bebidaList.add(new MenuItem("Pratos 2", "Descrição da pratos 2", 4.99, ""));
        bebidaList.add(new MenuItem("Pratos 1", "Descrição da pratos 1", 5.99, ""));
        bebidaList.add(new MenuItem("Pratos 2", "Descrição da pratos 2", 4.99, ""));
        bebidaList.add(new MenuItem("Pratos 2", "Descrição da pratos 2", 4.99, ""));

        cardapioAdapter = new CardapioAdapter(bebidaList);
